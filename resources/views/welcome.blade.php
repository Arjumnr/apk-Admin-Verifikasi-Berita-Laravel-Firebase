...
// document.getElementById("upload").addEventListener('change', hendelFileSelect, false);
});
...
function uploadData(){
var fbBucketName = 'image';
var fileName = selectedFile.name;
var storageRef = firebase.storage().ref(`${fbBucketName}/${fileName}`);
